...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAlumno" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
        <Columns>
            <asp:BoundField DataField="ID" HeaderText="ID" ItemStyle-CssClass="fila-grid" />
            <asp:BoundField DataField="NOMBRE" HeaderText="Nombre Solicitante" ItemStyle-CssClass="fila-grid" />
